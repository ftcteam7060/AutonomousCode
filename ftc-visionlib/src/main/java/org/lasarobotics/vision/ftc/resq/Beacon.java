...
public final class Beacon {
    ...
    public static class BeaconAnalysis {
        ...
        public Point getBlueCenter(List<Contour> contoursRed, List<Contour> contoursBlue,
                                   Mat img, Mat gray) {
            ...
            if (scoredContoursBlue == null) {
                Log.d("Beacon", "scoredBlue is null");
                return null;
            }
            else {
                Log.d("Beacon", "scoredBlue is NOT null");
                Contour bestBlue = (associations.blueContours.size() > 0) ? associations.blueContours.get(0).contour.contour : null;
                if (bestBlue != null) {
                    return bestBlue.center();
                }
                else {
                    return null;
                }
